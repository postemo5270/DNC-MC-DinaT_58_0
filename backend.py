...
class Transformador:
    ...
    # Atributos de Estado (Necesarios para el reporte)
    ...
    def calcular(self, kva_load, kw_load, kvar_load):
        # 1. Selección y Guardado en self
        ...
        return {
            "kVA_Com": self.kva_comercial, "Eff": self.eficiencia_doe, "Perdidas_kW": p_perdidas,
            "S_In": s_in, "FP_In": fp_in, "Cargabilidad": self.cargabilidad, 
            "I_Pri_Nom": i_pri, "I_Sec_Nom": i_sec
        }
